...
def add_items (verts, faces, ax, gw, data_colours, window):
    ...
    meshdata = MeshData(vertexes=verts, faces=faces, vertexColors=verts_colours)
...
def ubending_displacement (verts, faces, window):
    ...
    totalDisplacementField = displacementModel(surrogateModelInput).squeeze().detach().numpy() #total displacement
