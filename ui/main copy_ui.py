...
class Ui_main_window(object):
    def setupUi(self, main_window):
        ...
        self.grid_layout.addWidget(self.main_view, 0, 2, 6, 1)
        ...
        self.grid_layout.addWidget(self.model_dropdown, 2, 1, 1, 1)
        ...
        self.grid_layout.addWidget(self.GraphicsLayoutWidget, 0, 3, 6, 1)
        ...
        self.grid_layout.addWidget(self.dir_tree, 5, 0, 1, 2)
        ...
        self.grid_layout.addWidget(self.load_mesh_button, 4, 0, 1, 2)

        self.model_label = QLabel(self.central_widget)
        self.model_label.setObjectName(u"model_label")
        self.model_label.setMaximumSize(QSize(100, 16777215))

        self.grid_layout.addWidget(self.model_label, 2, 0, 1, 1)
        ...
        self.grid_layout.addWidget(self.direction_dropdown, 3, 1, 1, 1)

        self.direction_label = QLabel(self.central_widget)
        self.direction_label.setObjectName(u"direction_label")

        self.grid_layout.addWidget(self.direction_label, 3, 0, 1, 1)
    ...
    def retranslateUi(self, main_window):
        ...
        self.model_label.setText(QCoreApplication.translate("main_window", u"Model", None))
