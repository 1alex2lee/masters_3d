...
class Ui_main_window(object):
    def setupUi(self, main_window):
        ...
        self.formLayout.setWidget(1, QFormLayout.FieldRole, self.material_edit)
        ...
        self.formLayout.setWidget(2, QFormLayout.FieldRole, self.target_edit)
        ...
        self.formLayout.setWidget(14, QFormLayout.SpanningRole, self.eta_label)
    ...
    def retranslateUi(self, main_window):
        ...
        self.name_label.setText(QCoreApplication.translate("main_window", u"Component Name", None))
        ...
        self.label.setText(QCoreApplication.translate("main_window", u"Performance Indicator Name", None))
