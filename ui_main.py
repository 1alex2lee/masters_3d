...
class Ui_main_window(object):
    def setupUi(self, main_window):
        ...
        self.actionDeveloper = QAction(main_window)
        ...
        self.menuMode.addAction(self.actionDeveloper)
    ...
    def retranslateUi(self, main_window):
        ...
        self.actionDeveloper.setText(QCoreApplication.translate("main_window", u"Developer", None))
